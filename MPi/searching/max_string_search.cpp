...
// string cleaning and lowercase function
...
// ৩. MPI string exchange function
...
int main(int argc, char** argv) {
    ...
    int MIN_MATCH_LENGTH = 3; // default thresould
    int term_start_idx = 2;

    //(stoi avoid) check arg : argv[2] number or word?
...
//mpic++ max_string_search.cpp -o p
//mpirun -np 2 ./p phonebook1.txt PANGAMA
// lower and upper both